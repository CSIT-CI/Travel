...
<head>
	...
	<title>Book Your Travel - Self catering</title>
	...
	<script type="text/javascript">	
		$(document).ready(function(){
			$(".form").hide();
			$("#form2").show();
			$(".f-item:nth-child(3)").addClass("active");
			$(".f-item:nth-child(3) span").addClass("checked");			
		});
	</script>
</head>
<body>
			...
			<ul>
				<li>
					<div class="info animate-in">
						...
						<p>Find the perfect holiday home, villa, chalet or apartment.</p>
					</div>
	...
	<div class="main" role="main">		
		<div class="wrap clearfix">
			<!--deals-->
			<section class="full">
				<h1>Most popular Holiday Rentals</h1>
