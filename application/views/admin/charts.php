	...
	<header class="header navbar navbar-fixed-top" role="banner">
		...
		<div class="container">
			...
			<ul class="nav navbar-nav">
				<li class="nav-toggle"><a href="<?php echo base_url(); ?>javascript:void(0);" title=""><i class="icon-reorder"></i></a></li>
			</ul>
			...
			<!-- Sidebar Toggler -->
			<a href="<?php echo base_url(); ?>#" class="toggle-sidebar bs-tooltip" data-placement="bottom" data-original-title="Toggle navigation">
			...
			<ul class="nav navbar-nav navbar-left hidden-xs hidden-sm">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="<?php echo base_url(); ?>#"><i class="icon-user"></i> Example #1</a></li>
						<li><a href="<?php echo base_url(); ?>#"><i class="icon-calendar"></i> Example #2</a></li>
						<li class="divider"></li>
						<li><a href="<?php echo base_url(); ?>#"><i class="icon-tasks"></i> Example #3</a></li>
					</ul>
				</li>
			</ul>
			<!-- /Top Left Menu -->
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu extended notification">
						...
						<li class="footer">
							<a href="<?php echo base_url(); ?>javascript:void(0);">View all notifications</a>
						</li>
					</ul>
				</li>
				...
				<li class="dropdown hidden-xs hidden-sm">
					...
					<ul class="dropdown-menu extended notification">
						...
						<li class="footer">
							<a href="<?php echo base_url(); ?>javascript:void(0);">View all tasks</a>
						</li>
					</ul>
				</li>
				...
				<li class="dropdown hidden-xs hidden-sm">
					...
					<ul class="dropdown-menu extended notification">
						...
						<li class="footer">
							<a href="<?php echo base_url(); ?>javascript:void(0);">View all messages</a>
						</li>
					</ul>
				</li>
				...
				<!-- .row .row-bg Toggler -->
				<li>
					<a href="<?php echo base_url(); ?>#" class="dropdown-toggle row-bg-toggle">
				...
				<li class="dropdown">
					<a href="<?php echo base_url(); ?>#" class="project-switcher-btn dropdown-toggle">
				...
				<li class="dropdown user">
					...
					<ul class="dropdown-menu">
						<li><a href="<?php echo base_url(); ?>pages_user_profile.html"><i class="icon-user"></i> My Profile</a></li>
						<li><a href="<?php echo base_url(); ?>pages_calendar.html"><i class="icon-calendar"></i> My Calendar</a></li>
			...
			<div id="sidebar-content">
				...
				<ul id="nav">
					...
					<li>
						...
						<ul class="sub-menu">
							<li>
								<a href="<?php echo base_url(); ?>ui_general.html">
								<i class="icon-angle-right"></i>
								General
								</a>
							</li>
							<li>
								<a href="<?php echo base_url(); ?>ui_buttons.html">
								<i class="icon-angle-right"></i>
								Buttons
								</a>
							</li>
							<li>
								<a href="<?php echo base_url(); ?>ui_tabs_accordions.html">
								<i class="icon-angle-right"></i>
								Tabs &amp; Accordions
								</a>
							</li>
							<li>
								<a href="<?php echo base_url(); ?>ui_sliders.html">
								<i class="icon-angle-right"></i>
								Sliders
								</a>
							</li>
							<li>
								<a href="<?php echo base_url(); ?>ui_nestable_list.html">
								<i class="icon-angle-right"></i>
								Nestable List
								</a>
							</li>
							<li>
								<a href="<?php echo base_url(); ?>ui_typography.html">
								<i class="icon-angle-right"></i>
								Typography / Icons
								</a>
							</li>
							<li>
								<a href="<?php echo base_url(); ?>ui_google_maps.html">
								<i class="icon-angle-right"></i>
								Google Maps
								</a>
							</li>
							<li>
								<a href="<?php echo base_url(); ?>ui_grid.html">
								<i class="icon-angle-right"></i>
								Grid
								</a>
							</li>
					...
					<li>
						...
						<ul class="sub-menu">
							<li>
								<a href="<?php echo base_url(); ?>form_components.html">
								<i class="icon-angle-right"></i>
								Form Components
								</a>
							</li>
							<li>
								<a href="<?php echo base_url(); ?>form_layouts.html">
								<i class="icon-angle-right"></i>
								Form Layouts
								</a>
							</li>
							<li>
								<a href="<?php echo base_url(); ?>form_validation.html">
								<i class="icon-angle-right"></i>
								Form Validation
								</a>
							</li>
					...
					<li>
						...
						<ul class="sub-menu">
							<li>
								<a href="<?php echo base_url(); ?>tables_static.html">
								<i class="icon-angle-right"></i>
								Static Tables
								</a>
							</li>
							<li>
								<a href="<?php echo base_url(); ?>tables_dynamic.html">
								<i class="icon-angle-right"></i>
								Dynamic Tables (DataTables)
								</a>
							</li>
							<li>
								<a href="<?php echo base_url(); ?>tables_responsive.html">
								<i class="icon-angle-right"></i>
								Responsive Tables
								</a>
							</li>
					...
					<li class="current">
						<a href="<?php echo base_url(); ?>charts.html">
					...
					<li>
						...
						<ul class="sub-menu">
							...
							<li>
								<a href="<?php echo base_url(); ?>pages_user_profile.html">
								<i class="icon-angle-right"></i>
								User Profile
								</a>
							</li>
							...
							<li>
								<a href="<?php echo base_url(); ?>pages_invoice.html">
								<i class="icon-angle-right"></i>
								Invoice
								</a>
							</li>
							...
							<li class="open-default">
								...
								<ul class="sub-menu">
									<li class="open-default">
										...
										<ul class="sub-menu">
											<li class="current"><a href="<?php echo base_url(); ?>javascript:void(0);"><i class="icon-remove"></i> Sample Link 1</a></li>
											<li><a href="<?php echo base_url(); ?>javascript:void(0);"><i class="icon-pencil"></i> Sample Link 1</a></li>
											<li><a href="<?php echo base_url(); ?>javascript:void(0);"><i class="icon-edit"></i> Sample Link 1</a></li>
										</ul>
									</li>
									<li><a href="<?php echo base_url(); ?>javascript:void(0);"><i class="icon-user"></i>  Sample Link 1</a></li>
									<li><a href="<?php echo base_url(); ?>javascript:void(0);"><i class="icon-external-link"></i>  Sample Link 2</a></li>
									<li><a href="<?php echo base_url(); ?>javascript:void(0);"><i class="icon-bell"></i>  Sample Link 3</a></li>
								</ul>
							</li>
							<li>
								<a href="<?php echo base_url(); ?>javascript:void(0);">
								...
								<ul class="sub-menu">
									<li><a href="<?php echo base_url(); ?>javascript:void(0);"><i class="icon-user"></i>  Sample Link 1</a></li>
									<li><a href="<?php echo base_url(); ?>javascript:void(0);"><i class="icon-external-link"></i>  Sample Link 1</a></li>
									<li><a href="<?php echo base_url(); ?>javascript:void(0);"><i class="icon-bell"></i>  Sample Link 1</a></li>
								</ul>
							</li>
							<li>
								<a href="<?php echo base_url(); ?>javascript:void(0);">
			...
			<div class="container">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						<li>
							<i class="icon-home"></i>
							<a href="<?php echo base_url(); ?>index.html">Dashboard</a>
						</li>
						<li class="current">
							<a href="<?php echo base_url(); ?>pages_calendar.html" title="">Calendar</a>
						</li>
					</ul>

					<ul class="crumb-buttons">
						<li><a href="<?php echo base_url(); ?>charts.html" title=""><i class="icon-signal"></i><span>Statistics</span></a></li>
						<li class="dropdown"><a href="<?php echo base_url(); ?>#" title="" data-toggle="dropdown"><i class="icon-tasks"></i><span>Users <strong>(+3)</strong></span><i class="icon-angle-down left-padding"></i></a>
							<ul class="dropdown-menu pull-right">
							<li><a href="<?php echo base_url(); ?>form_components.html" title=""><i class="icon-plus"></i>Add new User</a></li>
							<li><a href="<?php echo base_url(); ?>tables_dynamic.html" title=""><i class="icon-reorder"></i>Overview</a></li>
							</ul>
						</li>
						<li class="range"><a href="<?php echo base_url(); ?>#">
						...
						<div class="widget box">
							...
							<div class="widget-content">
								<ul class="stats">
									<li>
										...
										<a href="<?php echo base_url(); ?>javascript:void(0);" class="title">Used RAM <i class="icon-angle-right"></i></a>
									</li>
									<li>
										<div class="circular-chart demo-reload" data-percent="80" data-bar-color="#e25856">-<span>80</span>%</div>
										<a href="<?php echo base_url(); ?>javascript:void(0);" class="title">Bounce Rate <i class="icon-angle-right"></i></a>
									</li>
									<li>
										<div class="circular-chart demo-reload" data-percent="26" data-bar-color="#8fc556"><span>26</span>%</div>
										<a href="<?php echo base_url(); ?>javascript:void(0);" class="title">New Visitors <i class="icon-angle-right"></i></a>
									</li>
								</ul>
							</div>
							<div class="divider"></div>
							<div class="widget-content">
								<ul class="stats">
									<li class="circular-chart-inline">
										<div class="circular-chart demo-reload" data-percent="62"><span>62</span>%</div>
										<a href="<?php echo base_url(); ?>javascript:void(0);" class="description">Used RAM <i class="icon-angle-right"></i></a>
									</li>
									<li class="circular-chart-inline">
										<div class="circular-chart demo-reload" data-percent="80" data-bar-color="#e25856">-<span>80</span>%</div>
										<a href="<?php echo base_url(); ?>javascript:void(0);" class="description">Bounce Rate <i class="icon-angle-right"></i></a>
									</li>
									<li class="circular-chart-inline">
										<div class="circular-chart demo-reload" data-percent="26" data-bar-color="#8fc556"><span>26</span>%</div>
										<a href="<?php echo base_url(); ?>javascript:void(0);" class="description">New Visitors <i class="icon-angle-right"></i></a>
									</li>
								</ul>
							</div>
						</div>
